...
export class FMA extends DisplayComponent<{ bus: EventBus, isAttExcessive: Subscribable<boolean> }> {
    ...
    private handleFMABorders() {
        ...
        const BC3Message = getBC3Message(this.props.isAttExcessive.get(), this.armedVerticalModeSub.get(),
            this.setHoldSpeed, this.trkFpaDeselected.get(), this.tcasRaInhibited.get(), this.tdReached, this.fcdcDiscreteWord1, this.fwcFlightPhase)[0] !== null;
...
class BC3Cell extends DisplayComponent<{ isAttExcessive: Subscribable<boolean>, bus: EventBus, }> {
    ...
    private fillBC3Cell() {
        const [text, className] = getBC3Message(
            this.isAttExcessive, this.armedVerticalMode, this.setHoldSpeed, this.trkFpaDeselected, this.tcasRaInhibited, this.tdReached, this.fcdcDiscreteWord1, this.fwcFlightPhase,
        );
